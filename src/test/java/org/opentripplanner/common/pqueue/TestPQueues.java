...
public class TestPQueues extends TestCase {
	...
	public void doQueue(BinHeap<Integer> q, List<Integer> input,
	...
	/*
	 * You must be careful to produce unique objects for rekeying, otherwise the
	 * same object might be rekeyed twice or more.
	 */
