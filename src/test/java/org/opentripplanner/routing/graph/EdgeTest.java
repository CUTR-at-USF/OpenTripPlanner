...
public class EdgeTest {
	...
	public void testConstruct() {
		...
		Vertex head = new SimpleConcreteVertex(graph, "head", 47.669457,
				-122.387577);
		Vertex tail = new SimpleConcreteVertex(graph, "tail", 47.669462,
				-122.384739);
	...
	public void testEdgeRemoval() {
		...
		Edge eab = new StreetEdge(va, vb, null, "AB", 10,
				StreetTraversalPermission.ALL, false);
		Edge ebc = new StreetEdge(vb, vc, null, "BC", 10,
				StreetTraversalPermission.ALL, false);
		Edge ecd = new StreetEdge(vc, vd, null, "CD", 10,
				StreetTraversalPermission.ALL, false);
