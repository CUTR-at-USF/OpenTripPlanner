...
public class PartialPlainStreetEdgeTest {
    ...
    public void testTraversalOfSubdividedEdge() {
        ...
        edges.add(e2);
        StreetLocation intermediate = StreetLocation.createStreetLocation(_graph, "middle of e2",
                "foo", edges, nearestPoint);

        RoutingRequest options = new RoutingRequest();
        options.setMode(TraverseMode.CAR);
        options.setRoutingContext(_graph, v1, v2);
        // Creating a streetlocation splits a street and makes temporary edges that are only visible
        // to one routing context.
    ...
    public void testReverseEdge() {
        PartialPlainStreetEdge pEdge1 = new PartialPlainStreetEdge(e1, v1, v2, e1.getGeometry(),
                "partial e1", e1.getLength());
        PartialPlainStreetEdge pEdge2 = new PartialPlainStreetEdge(e1Reverse, v2, v1,
                e1Reverse.getGeometry(), "partial e2", e1Reverse.getLength());
