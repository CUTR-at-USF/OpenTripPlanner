...
public class StreetTraversalPermissionTest {
	...
	public void testGetCode() {
		...
		StreetTraversalPermission perm2 = StreetTraversalPermission
				.get(perm1.code);
	...
	public void testRemove() {
		StreetTraversalPermission perm1 = StreetTraversalPermission.CAR;
		StreetTraversalPermission none = perm1
				.remove(StreetTraversalPermission.CAR);
	...
	public void testAllowsStreetTraversalPermission() {
		...
		assertTrue(perm1
				.allows(StreetTraversalPermission.PEDESTRIAN_AND_BICYCLE));
	...
	public void testAllowsTraverseModeSet() {
		...
		assertTrue(perm1.allows(new TraverseModeSet(
				TraverseMode.CUSTOM_MOTOR_VEHICLE, TraverseMode.TRAINISH,
				TraverseMode.FERRY)));
