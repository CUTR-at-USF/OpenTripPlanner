...
public class TestParkAndRide extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		Edge driveOnly = new StreetEdge(A, B, GeometryUtils.makeLineString(
				0.000, 45, 0.001, 45), "AB street", 87,
				StreetTraversalPermission.CAR, false);

		@SuppressWarnings("unused")
		Edge walkAndBike = new StreetEdge(B, C, GeometryUtils.makeLineString(
				0.001, 45, 0.002, 45), "BC street", 87,
				StreetTraversalPermission.PEDESTRIAN_AND_BICYCLE, false);

		@SuppressWarnings("unused")
		Edge walkOnly = new StreetEdge(C, D, GeometryUtils.makeLineString(
				0.002, 45, 0.003, 45), "CD street", 87,
	...
	public void testCar() throws Exception {
		...
		ParkAndRideVertex PRB = new ParkAndRideVertex(graph, "P+R", "P+R.B",
				0.001, 45.00001, "P+R B");
