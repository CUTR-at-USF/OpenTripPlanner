...
public class TurnRestrictionTest {
	...
	public void testForwardDefault() {
		...
		// Since there are no turn restrictions applied to the default modes
		// (walking + transit)
		// the shortest path is 1st to Main, Main to 2nd, 2nd to Broad and Broad
		// until the
	...
	public void testForwardAsCar() {
		...
		// If not for turn restrictions, the shortest path would be to take 1st
		// to Main,
		// Main to 2nd, 2nd to Broad and Broad until the corner of Broad and
		// 3rd.
		// However, most of these turns are not allowed. Instead, the shortest
		// allowed
