...
public class TestBikeRental extends TestCase {
	public void testBasic() throws Exception {
		...
		Edge walk = new StreetEdge(v1, v2, GeometryUtils.makeLineString(
				-77.0492, 38.856, -77.0492, 38.857), "S. Crystal Dr", 87,
				StreetTraversalPermission.PEDESTRIAN, false);

		@SuppressWarnings("unused")
		Edge mustBike = new StreetEdge(v2, v3, GeometryUtils.makeLineString(
				-77.0492, 38.857, -77.0492, 38.858), "S. Crystal Dr", 87,
				StreetTraversalPermission.BICYCLE, false);
		...
		options = new RoutingRequest(
				new TraverseModeSet("WALK,BICYCLE,TRANSIT"));
		...
		BikeRentalStationVertex stationVertex2 = new BikeRentalStationVertex(
				graph, station2);
		...
		// now we succeed!
		options = new RoutingRequest();
		new QualifiedModeSetSequence("BICYCLE_RENT,TRANSIT")
