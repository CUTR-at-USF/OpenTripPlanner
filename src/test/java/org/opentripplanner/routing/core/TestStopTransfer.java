...
public class TestStopTransfer extends TestCase {
    ...
    public void testStopTransfer() {
        ...
        transfer.addSpecificTransfer(new SpecificTransfer((AgencyAndId) null, null, null, null,
        ...
        transfer.addSpecificTransfer(new SpecificTransfer(null, toRoute2.getId(), null, null,
        ...
        transfer.addSpecificTransfer(new SpecificTransfer(null, toRoute2.getId(), null, toTrip2
                .getId(), StopTransfer.TIMED_TRANSFER));
        assertEquals(StopTransfer.FORBIDDEN_TRANSFER, transfer.getTransferTime(fromTrip, toTrip));
        ...
        transfer.addSpecificTransfer(new SpecificTransfer(fromRoute.getId(), toRoute2.getId(),
                fromTrip.getId(), null, StopTransfer.UNKNOWN_TRANSFER));
        assertEquals(StopTransfer.FORBIDDEN_TRANSFER, transfer.getTransferTime(fromTrip, toTrip));
        assertEquals(StopTransfer.UNKNOWN_TRANSFER, transfer.getTransferTime(fromTrip, toTrip2));
