...
public class TestSpecificTransfer extends TestCase {
    ...
    public void testSpecificTransfer() {
        ...
        SpecificTransfer s1 = new SpecificTransfer(fromRoute.getId(), toRoute.getId(),
                fromTrip.getId(), toTrip.getId(), 1);
        ...
        SpecificTransfer s3 = new SpecificTransfer(fromRoute.getId(), toRoute.getId(), null,
                toTrip.getId(), 3);
        ...
        SpecificTransfer s4 = new SpecificTransfer(fromRoute.getId(), toRoute.getId(),
                new AgencyAndId("A1", "T3"), toTrip.getId(), 4);
