...
public class TestSpecificTransfer extends TestCase {
	...
	public void testSpecificTransfer() {
		...
		SpecificTransfer s1 = new SpecificTransfer(fromRoute.getId(),
				toRoute.getId(), fromTrip.getId(), toTrip.getId(), 1);
		...
		SpecificTransfer s2 = new SpecificTransfer((AgencyAndId) null, null,
				null, null, 2);
		...
		SpecificTransfer s3 = new SpecificTransfer(fromRoute.getId(),
				toRoute.getId(), null, toTrip.getId(), 3);
		...
		SpecificTransfer s4 = new SpecificTransfer(fromRoute.getId(),
				toRoute.getId(), new AgencyAndId("A1", "T3"), toTrip.getId(), 4);
		...
		SpecificTransfer s5 = new SpecificTransfer(null, toRoute.getId(), null,
				toTrip.getId(), 5);
		...
		SpecificTransfer s6 = new SpecificTransfer(null, null, null,
				toTrip.getId(), 6);
		...
		SpecificTransfer s7 = new SpecificTransfer(fromRoute.getId(), null,
				null, null, 7);
