...
public class OSMNode extends OSMWithTags {
	...
	/**
	 * Is this a multi-level node that should be decomposed to multiple
	 * coincident nodes? Currently returns true only for elevators.
	 * 
	...
	/**
	 * Is this a public transport stop that can be linked to a transit stop
	 * vertex later on.
	 *
	...
	/**
	 * TODO Maybe all those methods (isSomething...) in OSMXxx should be moved
	 * to a dedicated OSM filtering class.
	 * 
