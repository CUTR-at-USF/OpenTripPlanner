...
public class OSMWithTags {
	...
	/**
	 * Determines if a tag contains a false value. 'no', 'false', and '0' are
	 * considered false.
	 */
	...
	/**
	 * Determines if a tag contains a true value. 'yes', 'true', and '1' are
	 * considered true.
	 */
	...
	/**
	 * Returns a name-like value for an entity (if one exists). The otp:
	 * namespaced tags are created by
	...
	public static boolean isFalse(String tagValue) {
		return ("no".equals(tagValue) || "0".equals(tagValue) || "false"
				.equals(tagValue));
	}

	public static boolean isTrue(String tagValue) {
		return ("yes".equals(tagValue) || "1".equals(tagValue) || "true"
				.equals(tagValue));
	}
	...
	/**
	 * Returns true if access is generally denied to this element (potentially
	 * with exceptions).
	 * 
	 * @return
	 */
	...
	public boolean isBikeParking() {
		return isTag("amenity", "bicycle_parking")
				&& !isTag("access", "private") && !isTag("access", "no");
	}
}
