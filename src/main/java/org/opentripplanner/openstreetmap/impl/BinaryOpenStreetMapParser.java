...
public class BinaryOpenStreetMapParser extends BinaryParser {
	...
	// but there appears to be a separate string table per 8k-entry PBF file
	// block.
	// String.intern grinds to a halt on large PBF files (as it did on GTFS
	// import), so
	 ...
	 * 
	 * @see org.opentripplanner.graph_builder.services
	 *      /.sm.OpenStreetMapContentHandler#triPhase
	 */
