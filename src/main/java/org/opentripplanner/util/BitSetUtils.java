...
/**
 * A compact bit set utility class. It rely on the client to store the bit set
 * himself (either as a byte, short, int or long, depending on the amount of
 * bits needed), to prevent having to store a reference and create another heavy
 * object instance such as with the BitSet class.
 * 
