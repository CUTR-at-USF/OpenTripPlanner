...
/**
 * The purpose of Properties is to easily read a ResourceBundel (set of
 * localized .properties files), and get the named contents. Goes really well
 * with an enumerated type (@see org.opentripplanner.api.ws.Message)
 */
public class Properties {
	 ...
	 * org.opentripplaner.blah.blah.blah.ClassName.properties. if that doesn't
	 * work, it searches for ClassName.properties.
	 */
	...
	public synchronized String format(String name, Locale l, Object... args) {
		try {
			...
			LOG.warn("couldn't find / format property " + name
					+ "; returning null", e);
		}
