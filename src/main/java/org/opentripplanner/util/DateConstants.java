...
public interface DateConstants {
    ...
    public static final List<String> DF_LIST = Collections.unmodifiableList(Arrays
            .asList(new String[] { "yyyy.MM.dd.HH.mm.ss", "yyyy.MM.dd.HH.mm",
    ...
    public static final List<String> SMALL_DF_LIST = Collections.unmodifiableList(Arrays
            .asList(new String[] { "M.d.yy", "yy.M.d", "h.mm a" }));
