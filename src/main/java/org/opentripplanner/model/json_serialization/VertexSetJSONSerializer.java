...
/**
 * This serializes an object containing Vertex objects, replacing any edges with
 * integer edge ids.
 * 
...
public class VertexSetJSONSerializer extends JsonSerializer<WithGraph> {
	...
	@Override
	public void serialize(WithGraph object, JsonGenerator jgen,
			SerializerProvider provider) throws IOException,
			JsonProcessingException {
		// FIXME: there is probably a simple way to automatically wire this up
		// that I can't find
		// right now
