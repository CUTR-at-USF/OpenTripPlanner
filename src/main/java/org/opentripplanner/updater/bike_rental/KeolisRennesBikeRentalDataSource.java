...
public class KeolisRennesBikeRentalDataSource extends
	...
	public BikeRentalStation makeStation(Map<String, String> attributes) {
		...
		brstation.bikesAvailable = Integer.parseInt(attributes
				.get("bikesavailable"));
		brstation.spacesAvailable = Integer.parseInt(attributes
				.get("slotsavailable"));
		return brstation;
	}
}
