...
/**
 * Load bike park from a KML placemarks. Use name as bike park name and point
 * coordinates. Rely on: 1) bike park to be KML Placemarks, 2) geometry to be
 * Point.
 * 
...
public class KmlBikeParkDataSource implements BikeParkDataSource,
	...
	private static final Logger LOG = LoggerFactory
			.getLogger(KmlBikeParkDataSource.class);
	...
	public KmlBikeParkDataSource() {
		...
		xmlDownloader
				.setDataFactory(new XmlDataListDownloader.XmlDataFactory<BikePark>() {
					@Override
