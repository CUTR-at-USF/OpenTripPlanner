...
/**
 * A read-only and .properties-file backed implementation of standard Java
 * "Preferences".
 * 
 * The generated Preference will have nodes based on the dotted-path of
 * properties, like path and filenames.
 * 
 */
public class PropertiesPreferences extends AbstractPreferences {
	...
	private PropertiesPreferences(AbstractPreferences parent, String name,
	...
	private void initFromProperties(Properties properties) {
		...
		for (String childName : childrenNodes) {
			children.put(childName, new PropertiesPreferences(this, childName,
					properties));
		}
	}
