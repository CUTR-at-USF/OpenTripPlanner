...
/**
 * Indicates that a vertex requested by name or lat/long could not be located. This might be thrown
 * if a user enters a location outside the street/transit network.
 */
