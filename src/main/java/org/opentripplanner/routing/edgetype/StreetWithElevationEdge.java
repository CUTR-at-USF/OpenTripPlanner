...
public class StreetWithElevationEdge extends StreetEdge {
	...
	public StreetWithElevationEdge(StreetVertex v1, StreetVertex v2,
	...
	public boolean setElevationProfile(PackedCoordinateSequence elev,
			boolean computed) {
		...
		boolean slopeLimit = getPermission().allows(
				StreetTraversalPermission.CAR);
		SlopeCosts costs = ElevationUtils.getSlopeCosts(elev, slopeLimit);

		packedElevationProfile = CompactElevationProfile
				.compactElevationProfile(elev);
	...
	public PackedCoordinateSequence getElevationProfile() {
		return CompactElevationProfile
				.uncompactElevationProfile(packedElevationProfile);
	}
	...
	public String toString() {
		return "StreetWithElevationEdge(" + getId() + ", " + getName() + ", "
				+ fromv + " -> " + tov + " length=" + this.getDistance()
				+ " carSpeed=" + this.getCarSpeed() + " permission="
				+ this.getPermission() + ")";
	}
}
