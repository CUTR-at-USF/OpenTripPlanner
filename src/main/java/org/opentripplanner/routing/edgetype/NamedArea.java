...
/**
 * A named area is a subset of an area with a certain set of properties (name,
 * safety, etc). Its originalEdges may include some edges which are crossable
 * (because they separate it from another contiguous and routeable area).
 * 
 */
