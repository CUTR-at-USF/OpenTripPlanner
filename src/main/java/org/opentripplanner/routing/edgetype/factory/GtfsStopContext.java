...
/**
 * Retains graph-wide information between GTFSPatternHopFactory runs on
 * different feeds.
 */
public class GtfsStopContext {
	...
	public Map<Stop, TransitStopArrive> stopArriveNodes = new HashMap<Stop, TransitStopArrive>(); // FIXME
																									// these
																									// are
																									// stored
																									// in
	...
	public Map<Stop, TransitStopDepart> stopDepartNodes = new HashMap<Stop, TransitStopDepart>(); // FIXME
																									// these
																									// are
																									// stored
																									// in
