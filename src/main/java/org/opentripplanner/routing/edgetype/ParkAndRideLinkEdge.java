...
public class ParkAndRideLinkEdge extends Edge {
	...
	/*
	 * By how much we have to really walk compared to straight line distance.
	 * This is a magic factor as we really can't guess, unless we know 1) where
	 * the user will park, and 2) we route inside the parking lot.
	 * 
	 * TODO: perhaps all of this obstruction and distance calculation should
	 * just be reduced to a single static cost. Parking lots are not that big,
	 * and these are all guesses.
	 */
	...
	/**
	 * The estimated distance between the center of the P+R envelope and the
	 * street access.
	 */
	...
	public State traverse(State s0) {
		// Do not enter park and ride mechanism if it's not activated in the
		// routing request.
		...
		if (mode == TraverseMode.WALK) {
			...
			// Driving
			double driveTime = linkDistance * DRIVE_OBSTRUCTION_FACTOR
					/ DRIVE_SPEED_MS;
