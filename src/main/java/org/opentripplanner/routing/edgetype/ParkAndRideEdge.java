 ...
 * 
 * We only allow going from CAR to WALK mode. Routing the opposite way would
 * need more information (ie knowing where you park your car in the first
 * place), and is probably better handled by a two-step routing (in walk mode
 * from origin to parking, then in car mode from the parking to destination).
 * 
 * @author laurent
 * 
 */
