...
/**
 * A termination strategy that terminates after multiple targets have been
 * reached.
 * 
 * Useful for implementing a restricted batch search - i.e. doing one-to-many
 * search without building a full shortest path tree.
 * 
 * @author avi
 */
public class MultiTargetTerminationStrategy implements
	...
	/**
	 * Updates the list of reached targets and returns True if all the targets
	 * have been reached.
	 */
	@Override
	public boolean shouldSearchTerminate(Vertex origin, Vertex target,
		...
		// TODO(flamholz): update this to handle vertices that are not in the
		// graph
