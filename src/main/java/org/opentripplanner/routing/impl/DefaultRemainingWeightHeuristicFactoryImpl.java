...
/**
 * This trivial RemainingWeightHeuristicFactory returns a Euclidean heuristic
 * instance for every search, irrespective of destination, modes, etc.
 * 
 * @author andrewbyrd
 */
public class DefaultRemainingWeightHeuristicFactoryImpl implements
	...
	private static final Logger LOG = LoggerFactory
			.getLogger(DefaultRemainingWeightHeuristicFactoryImpl.class);
