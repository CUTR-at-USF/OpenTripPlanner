...
public class SFBayFareServiceImpl extends DefaultFareServiceImpl {
	...
	private static final Logger LOG = LoggerFactory
			.getLogger(SFBayFareServiceImpl.class);
	...
	public static final Set<String> SFMTA_BART_TRANSFER_STOPS = new HashSet<String>(
			Arrays.asList("EMBR", "MONT", "POWL", "CIVC", "16TH", "24TH",
					"GLEN", "BALB", "DALY"));
					...
					if (ride.classifier == TraverseMode.CABLE_CAR) {
						...
						if (alightedBart != null
								...
								&& SFMTA_BART_TRANSFER_STOPS
										.contains(alightedBartStop)) {
							// discount for BART to Muni transfer
							if (alightedBartStop
									.equals(SFMTA_BART_FREE_TRANSFER_STOP)) {
						...
						// SFMTA-SFMTA non-cable-car transfer within time limit,
						// no cost
					}
