...
/**
 * Represents a day of transit services. Intended for quickly checking whether a
 * service is running during path searches.
 * 
 * @author andrewbyrd
 *
 */
public class ServiceDay implements Serializable {
	 ...
	 */
	public ServiceDay(Graph graph, long time, CalendarService cs,
			String agencyId) {
	...
	public ServiceDay(Graph graph, ServiceDate serviceDate, CalendarService cs,
			String agencyId) {
		TimeZone timeZone = cs.getTimeZoneForAgencyId(agencyId);
