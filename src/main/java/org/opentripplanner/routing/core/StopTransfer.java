...
/**
 * StopTransfer class used by TransferTable. Represents a transfer between two stops. Contains more
 * specific transfer information depending on the routes and trips that are involved. See the links
 * described at TransferTable for more details about the specifications.
 * 
 * @see TransferTable
 */
public class StopTransfer implements Serializable {
    ...
    /**
     * Special value for transferTime indicating that this transfer is timed. In a timed transfer,
     * the departing vehicle will wait for passengers from the arriving vehicle, so the minimum
     * transfer time is effectively zero.
     */
     ...
     *         be found in the *_TRANSFER constants.
     */
