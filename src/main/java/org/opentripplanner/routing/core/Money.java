...
public class Money implements Comparable<Money> {
	...
	/**
	 * The actual currency value in decimal fixed-point, with the default number
	 * of fraction digits from currency after the decimal point.
	 */
	private int cents;
	...
	public int compareTo(Money m) {
		if (m.currency != currency) {
			throw new RuntimeException("Can't compare " + m.currency + " to "
					+ currency);
		}
