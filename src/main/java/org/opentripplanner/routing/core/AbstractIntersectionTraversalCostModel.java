...
/**
 * Abstract turn cost model provides various methods most implementations will
 * use.
 * 
 * @author avi
 */
public abstract class AbstractIntersectionTraversalCostModel implements
	...
	/**
	 * Factor by which absolute turn angles are divided to get turn costs for
	 ...
	 * 
	 * TODO(flamholz): this should probably account for whether there is a
	 * traffic light?
	 */
	protected double computeNonDrivingTraversalCost(IntersectionVertex v,
			StreetEdge from, StreetEdge to, float fromSpeed, float toSpeed) {
	...
	/**
	 * Calculates the turn angle from the incoming/outgoing edges and routing
	 * request.
	 * 
	...
	protected int calculateTurnAngle(StreetEdge from, StreetEdge to,
		...
		// Put out to the right of in; i.e. represent everything as one long
		// right turn
	...
	@Override
	public abstract double computeTraversalCost(IntersectionVertex v,
