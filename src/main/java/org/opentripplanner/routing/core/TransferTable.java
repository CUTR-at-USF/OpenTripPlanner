...
public class TransferTable implements Serializable {
    ...
    public int getTransferTime(Stop fromStop, Stop toStop, Trip fromTrip, Trip toTrip,
        ...
        if (transferTime == StopTransfer.UNKNOWN_TRANSFER) {
            ...
            if (fromStop.getParentStation() != null && !fromStop.getParentStation().isEmpty()) {
                ...
                fromStopParentId = new AgencyAndId(fromStop.getId().getAgencyId(),
                        fromStop.getParentStation());
            }
            ...
            if (transferTime == StopTransfer.UNKNOWN_TRANSFER && fromStopParentId != null
                    && toStopParentId != null) {
     ...
     *         StopTransfer.UNKNOWN_TRANSFER is returned.
     */
    private int getTransferTime(AgencyAndId fromStopId, AgencyAndId toStopId, Trip fromTrip,
            Trip toTrip) {
     ...
     */
    public void addTransferTime(Stop fromStop, Stop toStop, Route fromRoute, Route toRoute,
            Trip fromTrip, Trip toTrip, int transferTime) {
        checkNotNull(fromStop);
        checkNotNull(toStop);
        ...
        SpecificTransfer specificTransfer = new SpecificTransfer(fromRoute, toRoute, fromTrip,
                toTrip, transferTime);
