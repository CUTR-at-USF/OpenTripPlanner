...
public class AutomatonState {
	...
	/**
	 * Signals that no transition was found for a given input symbol. The input
	 * is rejected.
	 */
	public static final int REJECT = Integer.MIN_VALUE;

	/**
	 * Could be used to provide a single accept state, using transitions on a
	 * special terminal from all other accept states.
	 */
	public static final int ACCEPT = Integer.MAX_VALUE;

	/**
	 * The states in a DFA should be ordered such that the start state is always
	 * 0.
	 */
	...
	/**
	 * A list of the states that can be reached from this state without
