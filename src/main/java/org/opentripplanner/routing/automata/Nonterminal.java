...
/**
 * An abstract superclass for all nonterminals, which are models for
 * instantiated NFAs. Also provides expression building methods which can be
 * used via a static import.
 * 
 * Thanks to Matt Might, whose self-described "toy Java library" inspired the
 * use of Java syntax to build up automata:
 * http://matt.might.net/articles/implementation
 * -of-nfas-and-regular-expressions-in-java/
 * 
 * His library also contained a comment suggesting the more functional style
 * provided here by the build() method.
 * 
 * @author abyrd
 */
public abstract class Nonterminal {
	 ...
	 * 
	 * @param entry
	 *            - the start state for the automaton to build
	...
	/*
	 * wrap terminals in trivial nonterminals to provide them with/to expression
	 * builder methods
	 */
