...
/**
 * RouteSegment holds the edges around one stop on particular trip or pattern. We can use this if we
 * patch the graph to remove the stop from the trip/pattern.
 */
