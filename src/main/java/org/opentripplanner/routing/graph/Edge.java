...
public abstract class Edge implements Serializable {
	...
	/**
	 * Checks equivalency to another edge. Default implementation is trivial
	 * equality, but subclasses may want to do something more tricky.
	 */
	...
	public boolean isReverseOf(Edge e) {
		return (this.getFromVertex() == e.getToVertex() && this.getToVertex() == e
				.getFromVertex());
	}
	...
	public String toString() {
		if (id >= 0) {
			return String.format("%s:%s (%s -> %s)", getClass().getName(), id,
					fromv, tov);
		}
