...
public class BasicPathParser extends PathParser {
    ...
    static {
         ...
         * a crosswalk. This code attempts to solve that problem. See issue #726. TODO: imlement a
         * complement operator. create tests for this specific situation and reimplement more
         * cleanly.
         */
