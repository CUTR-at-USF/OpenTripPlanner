...
public class PlannerError {
	...
	static {
		...
		messages.put(LocationNotAccessible.class,
	...
	/**
	 * @param missing
	 *            the list of point names which cannot be found (from, to,
	 *            intermediate.n)
	 */
	...
	/**
	 * @return the list of point names which cannot be found (from, to,
	 *         intermediate.n)
	 */
