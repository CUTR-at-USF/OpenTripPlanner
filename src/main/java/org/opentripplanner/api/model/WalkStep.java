...
/**
 * Represents one instruction in walking directions. Three examples from New
 * York City:
 * <p>
...
public class WalkStep {
	...
	/**
	 * This step is on an open area, such as a plaza or train platform, and thus
	 * the directions should say something like "cross"
	 */
	public Boolean area = false;

	/**
	 * The name of this street was generated by the system, so we should only
	 * display it once, and generally just display right/left directions
	 */
	...
	public String toString() {
		...
		return "WalkStep(" + direction + " on " + streetName + " for "
				+ distance + ")";
	}

	public static RelativeDirection getRelativeDirection(double lastAngle,
			double thisAngle, boolean roundabout) {
		...
		if (roundabout) {
			// roundabout: the direction we turn onto it implies the circling
			// direction
		...
		// less than 0.3 rad counts as straight, to simplify walking
		// instructions
