...
/**
 * An Itinerary is one complete way of getting from the start location to the
 * end location.
 */
public class Itinerary {
	...
	/**
	 * Indicates that the walk limit distance has been exceeded for this
	 * itinerary when true.
	 */
	public boolean walkLimitExceeded = false;

	/**
	 * How much elevation is lost, in total, over the course of the trip, in
	 * meters. As an example, a trip that went from the top of Mount Everest
	 * straight down to sea level, then back up K2, then back down again would
	 * have an elevationLost of Everest + K2.
	 */
	public Double elevationLost = 0.0;
	/**
	 * How much elevation is gained, in total, over the course of the trip, in
	 * meters. See elevationLost.
	 */
	...
	/**
	 * This itinerary has a greater slope than the user requested (but there are
	 * no possible itineraries with a good slope).
	 */
