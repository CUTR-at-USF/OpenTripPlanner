...
public class StopAgencyAndIdArrayListAdapter extends
	...
	@Override
	public ArrayList<Stop> unmarshal(ArrayList<AgencyAndIdType> arg)
			throws Exception {
	...
	@Override
	public ArrayList<AgencyAndIdType> marshal(ArrayList<Stop> arg)
			throws Exception {
		if (arg == null) {
			return null;
		}
		...
		for (Stop a : arg)
			result.add(new AgencyAndIdType(a.getId().getAgencyId(), a.getId()
					.getId()));
		return result;
	}
