...
/**
 * Holds information to be included in the REST Response for debugging and
 * profiling purposes.
 *
 * startedCalculating is called in the routingContext constructor.
 * finishedCalculating and finishedRendering are all called in
 * PlanGenerator.generate(). finishedPrecalculating and foundPaths are called in
 * the SPTService implementations.
 */
@XmlRootElement
public class DebugOutput {

	private static final Logger LOG = LoggerFactory
			.getLogger(DebugOutput.class);
	 ...
	 * finishedPrecalculating is also set because some heuristics will not mark
	 * any precalculation step, and path times are measured from when
	 * precalculation ends.
	 */
	public void startedCalculating() {
		startedCalculating = finishedPrecalculating = System
				.currentTimeMillis();
	}
