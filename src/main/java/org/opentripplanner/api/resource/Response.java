...
/**
 * Represents a trip planner response, will be serialized into XML or JSON by
 * Jersey
 */
@XmlRootElement
public class Response {
	...
	/**
	 * A dictionary of the parameters provided in the request that triggered
	 * this response.
	 */
	@XmlElement
	...
	/**
	 * Construct an new response initialized with all the incoming query
	 * parameters.
	 */
	public Response(UriInfo info) {
		...
		for (Entry<String, List<String>> e : info.getQueryParameters()
				.entrySet()) {
	...
	// NOTE: the order the getter methods below is semi-important, in that
	// Jersey will use the
	// same order for the elements in the JS or XML serialized response. The
	// traditional order
