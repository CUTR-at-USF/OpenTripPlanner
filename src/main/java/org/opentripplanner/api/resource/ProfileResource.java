...
/**
 * A Jersey resource class which exposes OTP profile routing functionality as a
 * web service.
 */
...
public class ProfileResource {
	...
	public ProfileResource(@Context OTPServer otpServer,
	...
	public Response profileRoute(
			...
			@QueryParam("streetTime") @DefaultValue("90") int streetTime, // max
																			// minutes
																			// to
																			// reach
																			// destination
																			// WITHOUT
																			// transit
			@QueryParam("maxWalkTime") @DefaultValue("15") int maxWalkTime, // max
																			// minutes
																			// to
																			// reach
																			// transit
		...
		try {
			...
			router.cleanup(); // destroy routing contexts even when an exception
								// happens
		}
