...
public class WayLoader extends Parser {
	...
	/**
	 * Load all ways that include at least one node whose ID is marked in the
	 * specified NodeTracker. Supply a NodeTracker.acceptEverything() to load
	 * all ways. TODO optimization: use null to mean "accept everything"
	 */
	...
	/**
	 * This method will be called with each new Way object as it is created. We
	 * keep all ways that have desired tags and at least one node within the
	 * geographic area, marking all nodes used in these ways.
	 */
	@Override
