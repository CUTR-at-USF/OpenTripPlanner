...
public class SyntheticRasterPopulation extends RasterPopulation {
	...
	public void createIndividuals() {
		...
		refEnvelope = new ReferencedEnvelope(left, right, bottom, top,
				coverageCRS);
