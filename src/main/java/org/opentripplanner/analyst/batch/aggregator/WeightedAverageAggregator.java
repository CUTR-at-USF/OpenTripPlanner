...
/**
 * An Aggregator which calculates the weighted average of the shortest path lengths to all
 * Individuals in the destination Population.
 * 
 * This can be used to find the average distance/time to all people or jobs in a metropolitan area
 * from a given origin.
 * 
 * @author andrewbyrd
 */
