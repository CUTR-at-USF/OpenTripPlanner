...
/**
 * A simple exponential decay (gravity) model, as defined in, for example Geurs, Karst T, and Bert
 * van Wee. "Accessibility Evaluation of Land-use and Transport Strategies: Review and Research
 * Directions." Journal of Transport Geography 12, no. 2 (2004): 127–140.
...
public class DecayAccumulator implements Accumulator {
    ...
    /**
     * This is the cost sensitivity parameter, the multiplier for the exponentiation of cost. See
     * Geurs and Wee 2004, 133. (Note that Geurs and Wee 2004 call it beta, but it's the same
     * variable)
     */
    @Setter
    double lambda;
    ...
    /**
     * This is a convenience function to set the cost sensitivity with more real-world values. The
     * value passed in is multiplied by 60 and the reciprocal is taken.
     * 
