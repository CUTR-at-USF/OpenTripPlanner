...
/**
 * Caches travel time surfaces, which are derived from shortest path trees. TODO add LRU behavior
 * upon get TODO extend to store any type by moving the IDs into the cache TODO use a disk-backed
 * MapDB to avoid eating memory
 */
