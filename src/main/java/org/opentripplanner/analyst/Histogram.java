...
/**
 * A histogram summing/counting all time values into 1-minute bins (0-60 seconds
 * = min 1, 61-120 = min 2, etc.)
 */
public class Histogram implements Serializable {
	 ...
	 * 
	 * @param times
	 *            the time at which each destination is reached. The array will
	 *            be sorted in place.
	 * @param weights
	 *            the weight or magnitude of each destination reached. parallel
	 *            to times.
	 */
	...
	public void writeJson(JsonGenerator jgen) throws JsonGenerationException,
			IOException {
