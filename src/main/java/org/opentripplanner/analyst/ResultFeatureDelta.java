...
public class ResultFeatureDelta extends ResultFeatureWithTimes {
	...
	public ResultFeatureDelta(SampleSet samples1, SampleSet samples2,
			TimeSurface surface1, TimeSurface surface2) {
		id = samples1.pset.id + "_" + surface1.id + "_" + surface2.id
				+ "_delta";
