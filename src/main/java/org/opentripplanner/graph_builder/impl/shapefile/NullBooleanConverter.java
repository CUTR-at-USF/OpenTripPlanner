...
/**
 * A converter which converts null-valued attributes to either true or false
 * (and all others to the other)
 * 
 * @author novalis
 * 
 */
public class NullBooleanConverter implements SimpleFeatureConverter<Boolean> {
	...
	/**
	 * @param nullIsTrue
	 *            whether a null value for this attribue converts to false
	 */
