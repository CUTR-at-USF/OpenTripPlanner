...
/**
 * A converter which is a composite of other converters. It can combine them
 * with an "and" or "or" strategy. The orPermissions variable controls that.
 * 
 * @author rob, novalis
 * 
 */
public class CompositeBooleanConverter implements
		SimpleFeatureConverter<Boolean> {
	...
	public CompositeBooleanConverter(
			SimpleFeatureConverter<Boolean>... converters) {
		this.converters = new ArrayList<SimpleFeatureConverter<Boolean>>(
	...
	/**
	 * use the permission combination strategy to combine the results of the
	 * list of converters
	 */
	@Override
