...
/**
 * A DelaunayEdge is a directed segment between two DelaunayPoints of the
 * triangulation.
 * 
...
interface DelaunayEdge<TZ> {
	...
	/**
	 * @param ccw
	 *            true (CCW) for A->B left edge, false (CW) for right edge.
	...
	/**
	 * @param ccw
	 *            For same value of ccw, will return the same side as
	 *            getEdge1().
	...
	/**
	 * HACK. This should not be here really. But with Java, attaching some user
	 * value to an object rely on another level of indirection and costly
	 * maps/arrays. Exposing this flag directly here saves *lots* of processing
	 * time. TODO Is there a better way to do that?
	 * 
 ...
 * 
 * A simple interface returning a collection (an iterable) of DelaunayEdges. The
 * interface is kept minimal for isoline building purposes.
 * 
 * @author laurent
 * @param TZ
