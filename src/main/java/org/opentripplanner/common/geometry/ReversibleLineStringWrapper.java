...
public class ReversibleLineStringWrapper {
	...
	public boolean matchesBackward(CoordinateSequence cs0,
	...
	public int hashCode() {
		...
		int x = (int) (cs.getX(0) * 1000000)
				+ (int) (cs.getX(maxIdx) * 1000000);
		int y = (int) (cs.getY(0) * 1000000)
				+ (int) (cs.getY(maxIdx) * 1000000);
