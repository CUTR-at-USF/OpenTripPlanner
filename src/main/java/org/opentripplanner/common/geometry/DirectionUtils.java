...
public class DirectionUtils {
	...
	/**
	 * Returns the approximate azimuth from coordinate A to B in decimal degrees
	 * clockwise from North, in the range (-180° to +180°). The computation is
	 * exact for small delta between A and B.
	 */
	 ...
	 * in radians clockwise from North in the range (-PI, PI).
	 * 
	 * @param geometry
	...
	/**
	 * Computes the angle of the first segment of a LineString or
	 * MultiLineString in radians clockwise from North in the range (-PI, PI).
	 * 
	 * @param geometry
	 *            a LineString or a MultiLineString
	 */
