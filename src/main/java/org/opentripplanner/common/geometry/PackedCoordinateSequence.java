 ...
 * 
 * 2009-11-25 - bdferris - This class copied from JTS (LGPL-licensed) to add
 * {@link Serializable} to the class so that we can serialize it with our graphs
 * 
 * @version 1.7
 */
public abstract class PackedCoordinateSequence implements CoordinateSequence,
	...
	public static class Double extends PackedCoordinateSequence {
		...
		/**
		 * Builds a new packed coordinate sequence out of a float coordinate
		 * array
		 * 
		 * @param coordinates
		 */
		...
		/**
		 * Builds a new empty packed coordinate sequence of a given size and
		 * dimension
		 * 
		 * @param coordinates
		 */
		 ...
		 *      int) Beware, for performace reasons the ordinate index is not
		 *      checked, if it's over dimensions you may not get an exception
		 *      but a meaningless value.
		 */
	...
	public static class Float extends PackedCoordinateSequence {
		...
		/**
		 * Constructs an empty packed coordinate sequence of a given size and
		 * dimension
		 * 
		 * @param coordinates
		 */
