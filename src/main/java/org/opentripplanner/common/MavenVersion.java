...
public class MavenVersion implements Serializable {
    ...
    private static MavenVersion fromProperties() {
        ...
        try {
            ...
            MavenVersion version = new MavenVersion(props.getProperty("project.version"),
                    ...
                    props.getProperty("git.commit.time"), props.getProperty("git.build.time"));
    ...
    public MavenVersion(String version, String commit, String describe, String commit_time,
            String build_time) {
    ...
    public String toString() {
        return String.format("MavenVersion(%d, %d, %d, %s, %s)", major, minor, incremental,
                qualifier, commit);
    }
    ...
    public boolean equals(Object other) {
        ...
        return this.major == that.major && this.minor == that.minor
                && this.incremental == that.incremental && this.qualifier.equals(that.qualifier);
    }
}
