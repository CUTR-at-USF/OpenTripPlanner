 ...
 * 
 * Query parameters are matched with setter methods according to the usual convention: changing the
 * first character to upper case and prepending 'set'. A setter method invocation will be preferred
 * to directly setting the field with the corresponding name, if it exists.
 * 
 * @author andrewbyrd
 */
