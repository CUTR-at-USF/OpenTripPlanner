...
/**
 * Render important information for debugging wheelchair access (street slopes
...
public class WheelchairEdgeRenderer implements EdgeVertexRenderer {
	...
	private ScalarColorPalette slopePalette = new DefaultScalarColorPalette(
			0.0, 0.08, 1.0);
	...
	@Override
	public boolean renderEdge(Edge e,
