...
/**
 * Render bike safety for each edge using a color palette. Display the bike
 * safety factor as label.
 * 
 * @author laurent
 * 
 */
public class BikeSafetyEdgeRenderer implements EdgeVertexRenderer {
	...
	private ScalarColorPalette palette = new DefaultScalarColorPalette(1.0,
			3.0, 10.0);
