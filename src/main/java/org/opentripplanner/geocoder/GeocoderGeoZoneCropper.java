...
/**
 * Filter results of a geocoding request by removing elements outside of the
 * covered geographical zone.
 */
public class GeocoderGeoZoneCropper implements Geocoder {
	...
	public GeocoderGeoZoneCropper(Geocoder decorated, double minLat,
