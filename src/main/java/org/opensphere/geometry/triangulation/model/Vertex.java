...
public class Vertex {
     ...
     * 
     * @param id ID of the vertex
     * @param border defines if the vertex is a border vertex or not in the triangulation framework
     */
    ...
    /**
     * Returns true if the vertex is a border vertex of the triangulation framework, false
     * otherwise.
     * 
