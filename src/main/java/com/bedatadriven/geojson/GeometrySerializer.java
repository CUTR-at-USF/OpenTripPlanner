...
public class GeometrySerializer extends JsonSerializer<Geometry> {
    ...
    public void writeGeometry(JsonGenerator jgen, Geometry value) throws JsonGenerationException,
            IOException {
    ...
    private void writePolygon(JsonGenerator jgen, Polygon value) throws JsonGenerationException,
            IOException {
        jgen.writeStartObject();
    ...
    private void writePoint(JsonGenerator jgen, Point p) throws JsonGenerationException,
            IOException {
        jgen.writeStartObject();
